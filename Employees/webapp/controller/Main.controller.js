...
sap.ui.define([
    ...
    return Controller.extend("logaligroup.Employees.controller.Main", {
        ...
        onInit: function () {
            ...
            this._bus.subscribe("incidence", "onDeleteIncidence",
        ...
        showEmployeeDetails: function (category, nameEvent, path) {
            ...
            //detailView.byId("tableIncidence").removeAllContenet();
        ...
        onSaveODataIncidence: function (channelId, eventId, data) {
            ...
            } else if (incidenceModel[data.incidenceRow].CreationDateX || incidenceModel[data.incidenceRow].ReasonX || incidenceModel[data.incidenceRow].TypeX) {
